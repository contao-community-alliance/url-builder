...
If you haven't already, come find us in IRC (#contao.dev on freenode).
We want you working on things you're excited about.

The following is a set of guidelines for contributing to our packages, 
which are hosted in the [contao-community-alliance organization][1] on GitHub. 
...
* Describe the issue in detail and include all the steps to follow in order to
  reproduce the bug.
* Include the version of Contao, PHP and the package you are using (if possible
...
* Please send a [GitHub Pull Request][1] with a clear list of what you've done 
  (read more about [pull requests][2]).
...
[4]: https://github.com/contao-community-alliance/url-builder/pull/new/master
[5]: https://github.com/contao-community-alliance/url-builder/pull/new/develop
